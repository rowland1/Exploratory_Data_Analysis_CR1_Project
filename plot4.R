...
par(mfrow = c(2,2))
with(epc_datasubset, {
    plot(epc_datasubset$Datetime, epc_datasubset$Global_active_power, type="l", ylab = "Global Active Power (kilowatts)", xlab="")
    ...
    plot(epc_datasubset$Datetime, epc_datasubset$Sub_metering_1,type = "l", col = "black", xlab = "", ylab = "Energy Sub-Metering")
      ...
      legend("topright", cex =0.5, bty = "n", col = c("black", "red", "blue"), c("Sub-Metering 1", "Sub-Metering 2", "Sub-Metering 3"), lwd = 1)
      plot(epc_datasubset$Datetime, epc_datasubset$Global_reactive_power, type = "l", ylab = "Global Reactive Power", xlab = "datetime")
})
